...
void main() {
  const Map<String, String> characters = HtmlCharacterEntities.characters;

  const Map<String, String> entities = HtmlCharacterEntities.entities;

  const Map<String, String> asciiCodes = HtmlCharacterEntities.asciiCodes;

  test('Cross-check the maps', () {
    characters.forEach((String characterCode, String character) {
      if (character.isEmpty) return;

      expect((entities.containsKey(character) ||
        asciiCodes.containsKey(character)), equals(true));
